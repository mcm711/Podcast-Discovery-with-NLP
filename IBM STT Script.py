...
authenticator = IAMAuthenticator('Gx9e5JFnW3plXER31LcMLBMw9LWZJ2WLrxb47cj1mX')
speech_to_text = SpeechToTextV1(
    authenticator=authenticator
)
#Copy and paste the url from your credentials 
speech_to_text.set_service_url('https://api.us-south.speech-to-text.watson.cloud.ibm.com/instances/8413e7b4-bb7b-4f7f-ad99-e046b7c78184')
...
write_pickle(the_data_out, "Podcast1.pkl", res)

#Change "Podcast1" to match the name of the podcast episode
#Do this for each podcast you convert to text
with open('Podcast1.txt', 'w') as out:
    out.writelines(text)
